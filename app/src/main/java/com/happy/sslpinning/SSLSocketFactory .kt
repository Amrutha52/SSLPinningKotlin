...
//    .build()
//
//// Create a Retrofit instance using your OkHttpClient
//val retrofit = Retrofit.Builder()
//    .baseUrl("https://test3.maxvalue.co.in:1251/api/YardAppDetails/")
//    .addConverterFactory(GsonConverterFactory.create())
//    .client(okHttpClient)
//    .build()

val context = MainActivity.appContext
val certificateInputStream = context.resources.openRawResource(R.raw.maxvalue_certificate_03_04_2024)
///val certificateInputStream = context.resources.openRawResource(R.raw.maxvalue_certificate_03_04_2024)
val sslSocketFactory = CustomSSLSocketFactory.getSocketFactory(certificateInputStream)
val client = OkHttpClient.Builder()
    .sslSocketFactory(sslSocketFactory!!, TrustManagerBuilder.trustAllCertificates()) // Trust all certificates (optional)
    .build()
...
//val certificatePinner = CertificatePinner.Builder()
//    .add(
//        "test3.maxvalue.co.in",
//        "sha256/MIIGNjCCBR6gAwIBAgIJAMMPdHTC7eM5MA0GCSqGSIb3DQEBCwUAMGYxCzAJBgNV\\n\" +\n" +
//                "                    \"BAYTAklOMRMwEQYDVQQLEwplbVNpZ24gUEtJMSUwIwYDVQQKExxlTXVkaHJhIFRl\\n\" +\n" +
//                "                    \"Y2hub2xvZ2llcyBMaW1pdGVkMRswGQYDVQQDExJlbVNpZ24gU1NMIENBIC0gRzEw\\n\" +\n" +
//                "                    \"HhcNMjQwMzIzMjMyMDA1WhcNMjUwNDE3MjMyMDA1WjAbMRkwFwYDVQQDDBAqLm1h\\n\" +\n" +
//                "                    \"eHZhbHVlLmNvLmluMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA4WZT\\n\" +\n" +
